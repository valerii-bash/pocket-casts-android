...
private fun DiskSpaceSizeRow(
    ...
    SettingRow(
        ...
        switchState = diskSpaceSizeView.isChecked,
        modifier = modifier.toggleable(value = diskSpaceSizeView.isChecked, role = Role.Checkbox) { onDiskSpaceCheckedChanged(it, diskSpaceSizeView) }
    )
}
...
private fun IncludeStarredRow(
    ...
    SettingRow(
        ...
        modifier = modifier.toggleable(value = checkedState, role = Role.Switch) { onStarredSwitchClicked(it) }
    )
}
